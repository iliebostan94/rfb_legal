...
<section class="theme_insights_slider_section_default bg-white w-full text-black py-10 lg:py-12">
  <div class="max-w-7xl max-h-full mx-auto">
    <div class="meet-team-carousel-title max-w-4xl mb-10 mx-auto text-center">
      <h2 class="text-4xl font-semibold text-brandBlue">
        <?php echo $insights_section_title ?>
      </h2>
      ...
      <p class="meet-team-carousel-subtitle text-lg font-normal text-utilityGrey">
        <?php echo $insights_section_subtitle ?>
      </p>
    </div>
    <div id="insights-carousel" class="slider glide glide--swipeable glide--carousel glide--ltr glide--slider">
        ...
        <ul class="glide__slides gap-6">
          ...
          <a href="<?php echo $permalink; ?>" class="test-unit insight-unit-<?php echo $insight_item_order ?>">
            <div id="insight-unit-<?php echo $insight_item_order++ ?>" class="glide__slide h-72 ">
              <img src="<?php echo $post_thumbnail ?>" alt="image" class="h-3/5 w-full object-cover rounded-t-xl" />
