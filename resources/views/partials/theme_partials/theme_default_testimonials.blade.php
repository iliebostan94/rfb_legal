...
$group = acf_get_field_group('group_654deb926289b'); // your field group key
      ...
      while( have_rows('general_theme_testimonials_repeater', 'options') ) : the_row();
        ...
        ?>
        <div class="hidden duration-200 ease-linear px-6 md:px-12 lg:px-16 text-center " data-carousel-item>
          <h3 class="leading-relaxed text-xl md:text-2xl lg:text-4xl font-semibold mb-2 lg:mb-8">Testimonials</h3>
          <p class="text-xl md:text-2xl lg:text-2xl text-white font-bold mb-8"><?php echo $testimonial_content ?></p>
