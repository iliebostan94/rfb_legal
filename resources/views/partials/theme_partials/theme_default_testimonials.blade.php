<section class="theme_default_testimonials_section gradientBlueBackground w-full text-white relative z-10">
    ...
    <div id="animation-carousel" class="relative w-full text-center min-h-340" data-carousel="static">
      ...
      <div class="hidden duration-200 ease-linear px-6 md:px-12 lg:px-16 text-center text-lightGold" data-carousel-item>
        <div class="flex justify-center mb-8">
          <?php
          if ( is_page_template('about-us-template.blade.php') ) {
            ?>
            <img class="w-16 h-12" src="/wp-content/themes/rfb-legal/resources/images/quote_brand_blue.svg" alt="testimonials">
            <?php
          } else {
            ?>
            <img class="w-16 h-12" src="/wp-content/themes/rfb-legal/resources/images/quote_brand_gold.svg" alt="testimonials">
            <?php
          } ?>
{{--          <img class="w-16 h-12" src="/wp-content/themes/rfb-legal/resources/images/quote_brand_gold.svg" alt="testimonials">--}}

        </div>
        <p class="testimonials_content text-xl md:text-2xl lg:text-2xl font-bold mb-6 lg:mb-8">
            <?php echo $testimonial_content ?>
        </p>
        <div class="w-full flex justify-center my-8 ">
          <div class="w-20 bg-accentGold h-1 rounded-full"> </div>
        </div>
        <p class="testimonials_author text-white text-xl font-extrabold title-font tracking-wider">
            <?php echo $testimonial_author ?>
        </p>
        <p class="testimonials_author_position text-white text-base font-normal title-font tracking-wider">
      ...
      <button type="button"
        ...
        <span
          ...
          <?php
            if ( is_page_template('about-us-template.blade.php') ) {
              ?>
              <img class="w-8 h-8" src="/wp-content/themes/rfb-legal/resources/images/grey_arrow_forward.svg" alt="arrow blue svg">
              <?php
            } else {
              ?>
              <img class="w-8 h-8 rotate-180" src="/wp-content/themes/rfb-legal/resources/images/arrow_forward_white.svg" alt="arrow white svg">
              <?php
            } ?>
{{--          <img class="w-8 h-8 rotate-180" src="/wp-content/themes/rfb-legal/resources/images/arrow_forward_white.svg" alt="arrow-svg">--}}
      ...
      <button type="button"
        ...
        <span
          ...
          if ( is_page_template('about-us-template.blade.php') ) {
            ?>
            <img class="w-8 h-8 rotate-180" src="/wp-content/themes/rfb-legal/resources/images/grey_arrow_forward.svg" alt="arrow blue svg">
            <?php
          } else {
            ?>
            <img class="w-8 h-8" src="/wp-content/themes/rfb-legal/resources/images/arrow_forward_white.svg" alt="arrow white svg">
            <?php
          } ?>
{{--          <img class="w-8 h-8" src="/wp-content/themes/rfb-legal/resources/images/arrow_forward_white.svg" alt="arrow-svg">--}}
