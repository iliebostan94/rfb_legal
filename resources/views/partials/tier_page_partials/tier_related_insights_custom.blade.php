...
<div id="custom_tier_related_insights" class="slider glide glide--swipeable glide--carousel glide--ltr glide--slider my-6 lg:my-10 px-8 lg:px-0">
  <div data-glide-el="track" class="slider__track glide__track">
    <ul class="glide__slides gap-6">
      ...
      <a href="<?php echo $insight_permalink; ?>" class="custom_tier_related_insights_unit custom_tier_related_insights-<?php echo $custom_tier_related_insights_count ?>">
        <div id="custom_tier_related_insights-<?php echo $custom_tier_related_insights_count++ ?>" class="glide__slide h-72 ">
...
<div class="all_insights_link_wrapper text-center">
  <a href="/insights/"
